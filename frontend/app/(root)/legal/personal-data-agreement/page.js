...
import { address, inn, name, ogrn } from '@/lib/settings'
    ...
    return (
        <PageWrapper title="Согласие Пользователя на обработку персональных данных">
            <Card sx={{ p: 3 }}>
                ...
                <Paragraph>
                    <b>1. Согласие выдано Обществу с ограниченной ответственностью «{name}» (ООО «{name}», ИНН {inn}, ОГРН {ogrn})</b>, расположенному по адресу: {address} (далее-Оператор).
                </Paragraph>
                <Paragraph>
                ...
                <Paragraph>
                    <b>6. Согласие вступает в силу с момента его отправки и может быть отозвано Пользователем</b> путем направления письменного заявления в произвольной форме в адрес Оператора по адресу {/*электронной почты*/}{address} либо иным способом, позволяющим однозначно определить факт его получения адресатом.
                </Paragraph>
                <Paragraph>
