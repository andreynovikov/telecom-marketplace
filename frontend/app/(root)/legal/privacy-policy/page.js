...
export default async function PrivacyPolicy() {
    return (
        <PageWrapper title="Политика конфиденциальности">
            <Card sx={{ p: 3 }}>
                <Paragraph>
                    Политика конфиденциальности Общества с ограниченной ответственностью «{name}» (сокращенное наименование - ООО «{name}» (ИНН {inn}, ОГРН {ogrn}) (далее - Администрация), разработана в соответствии с положениями законодательства Российской Федерации{/* и Правилами использования Сервиса Приложения, размещенными на сайте ПРИЛОЖЕНИЕ.ru по адресу: ___________*/}.
                </Paragraph>
                <Paragraph>
                    Политика конфиденциальности ООО «{name}» (далее – Политика) является приложением к Правилам использования Сервиса Приложения и их неотъемлемой частью. Принимая условия Правил использования Сервиса Приложения, Пользователь автоматически принимает условия настоящей Политики.
                </Paragraph>
                <Header>
